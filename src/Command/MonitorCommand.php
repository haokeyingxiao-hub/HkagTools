...
#[AsCommand('hkag:monitor', 'Monitor your scheduled tasks and queue with this command and get notified via email.')]
class MonitorCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!empty($recepientMail) && ($this->queueFailed() || $this->scheduledTaskFailed())) {
            ...
            $data->set('senderName', 'Hkagtools | Admin');
            ...
            $htmlMailContent = <<<'MAIL'
                <div>
                    <p>
                        ...
                        <br/>
                        <br/>
                        Check your queues and tasks <a href="{{ salesChannel.domains|first.url }}/admin#/hkag/tools/index/index">here</a>
                    </p>
                </div>
                MAIL;
            $plainMailContent = 'Dear Admin,your message queue or scheduled tasks are not working as expected.Check your queues and tasks {{ salesChannel.domains|first.url }}/admin#/hkag/tools/index/index';
            ...
            $data->set('subject', 'Hkagtools message queue and scheduled task | Warning');
    ...
    private function queueFailed(): bool
    {
        ...
        $minutes = $this->configService->getInt(
            'HkagTools.config.monitorQueueGraceTime',
        );
    ...
    {
        $minutes = $this->configService->getInt(
            'HkagTools.config.monitorTaskGraceTime',
        );
