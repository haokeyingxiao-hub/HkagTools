...
namespace Hkag\Tools\Components\SystemConfig;
...
class ConfigSystemConfigLoader extends AbstractSystemConfigLoader
{
     ...
     */
    public function __construct(private readonly AbstractSystemConfigLoader $decorated, #[Autowire('%hkag_tools.system_config%')] private readonly array $config) {}
