...
class SymfonyConfigCompilerPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        $container->setParameter('hkag_tools.mail_over_queue', $mailer->getArgument(1) !== null);
        ...
        if (\is_string($defaultHandler)) {
            $container->setParameter('hkag_tools.queue_connection', $defaultHandler);
        } else {
            $container->setParameter('hkag_tools.queue_connection', 'unknown://default');
        }
    }
}
