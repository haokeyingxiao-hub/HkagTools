...
use Hkag\Tools\Components\CacheHelper;
...
class CacheController extends AbstractController
{
    ...
    #[Route(path: '/cache', name: 'api.hkag.tools.cache.get', methods: ['GET'])]
    ...
    #[Route(path: '/cache/{folder}', name: 'api.hkag.tools.cache.clear', methods: ['DELETE'])]
