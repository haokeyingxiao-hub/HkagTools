...
use Hkag\Tools\Components\Planuml;
use Hkag\Tools\Components\StateMachines\Mermaid;
use Hkag\Tools\Components\StateMachines\Plantuml;
...
final class StateMachineController extends AbstractController
{
    ...
    #[Route(path: '/state-machines/load/{stateMachineId}', name: 'api.hkag.tools.state-machines.load', methods: ['GET'])]
    ...
    #[Route(path: '/state-machines/load-mermaid', name: 'api.hkag.tools.state-machines.load-mermaid', methods: ['GET'])]
