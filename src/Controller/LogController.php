...
use Hkag\Tools\Components\LineReader;
...
class LogController extends AbstractController
{
    ...
    #[Route(path: '/logs/files', name: 'api.hkag.tools.logs.files', methods: ['GET'])]
    public function getLogFiles(): JsonResponse
    {
        return new JsonResponse($this->getFiles());
    }

    #[Route(path: '/logs/file', name: 'api.hkag.tools.logs.file-listing', methods: ['GET'])]
