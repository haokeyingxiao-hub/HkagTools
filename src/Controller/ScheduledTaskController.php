...
class ScheduledTaskController extends AbstractController
{
    ...
    #[Route(path: '/scheduled-task/{id}', name: 'api.hkag.tools.scheduled.task.run', methods: ['POST'])]
    ...
    #[Route(path: '/scheduled-tasks/register', name: 'api.hkag.tools.scheduled.tasks.register', methods: ['POST'])]
