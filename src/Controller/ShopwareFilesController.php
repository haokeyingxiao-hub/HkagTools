...
#[AutoconfigureTag('monolog.logger', ['channel' => 'hkag-tools'])]
...
class ShopwareFilesController extends AbstractController
{
    ...
    public function __construct(
        ...
        #[Autowire('%hkag_tools.file_checker.exclude_files%')]
        private readonly array $projectExcludeFiles,
        private readonly LoggerInterface $hkagToolsLogger,
    ...
    #[Route(path: '/file-contents', name: 'api.hkag.tools.file-contents', methods: ['GET'])]
    ...
    #[Route(path: '/shopware-file/restore', name: 'api.hkag.tools.shopware-file.restore', methods: ['GET'])]
    public function restoreShopwareFile(Request $request, Context $context): JsonResponse
    {
        ...
        $this->hkagToolsLogger->info($message);
